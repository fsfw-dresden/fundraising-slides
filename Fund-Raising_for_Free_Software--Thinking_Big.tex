...
\raisebox{-15mm}{ \includegraphics[width=0.6\textwidth]{img-src/atmosfair_logo_en}}
% \end{center}
...
\visible<4->{
\textbf{Update} (after the talk):
\medskip
\tiny
\begin{itemize}
 \item After the talk a 2h discussion took place
 \item Some people exchanged mail addresses
 \item The FSFE dedicated a discussion platform for that:\\
 \url{https://community.fsfe.org/c/activities/funding-foss}

 \item Ideas and comments are welcome in \href{https://pad.fsfw-dresden.de/p/funding-foss-35c3}{this pad}
